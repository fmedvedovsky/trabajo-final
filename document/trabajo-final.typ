...
- *bindgen*:  es una librería que genera automáticamente enlaces FFI de Rust para librerías de C y C++. El repositorio se encuentra dentro del perfil oficial de Github para el lenguaje Rust.
